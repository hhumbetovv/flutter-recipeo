            ...
            children: [
              ...
              Expanded(
                child: TextFormField(
                  ...
                  onChanged: (value) => context.read<UploadRecipeCubit>().setReordableElement<StepModel>(value, index),
              ...
              if (!isSingle) ...[
                ...
                AppInkWell(
                  onTap: () {
                    context.read<UploadRecipeCubit>().removeReordableElement<StepModel>(index);
                  },
