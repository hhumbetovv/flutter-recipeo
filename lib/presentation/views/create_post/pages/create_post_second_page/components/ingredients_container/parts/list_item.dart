        ...
        children: [
          ...
          Expanded(
            child: TextFormField(
              ...
              onChanged: (value) => context.read<CreatePostCubit>().setReordableElement<IngredientModel>(value, index),
          ...
          if (!isSingle) ...[
            ...
            AppInkWell(
              onTap: () {
                context.read<CreatePostCubit>().removeReordableElement<IngredientModel>(index);
              },
